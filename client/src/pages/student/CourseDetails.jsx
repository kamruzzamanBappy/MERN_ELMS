...
<div className="flex items-center gap-1">
  <img src={assets.star} alt="satar icon" />
  <p>{calculateRating(courseData)}</p>
</div>
...
<button className="md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium">{isAllreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'}</button>
