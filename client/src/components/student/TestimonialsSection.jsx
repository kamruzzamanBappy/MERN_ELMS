...
const TestimonialsSection = () => {
  return (
    <div className="pb-14 px-8 md:px-0">
      ...
      <p className="md:text-base text-gray-500 mt-3">Hear from our learners as they share their journey of transformation and how our <br /> platform has made a different in their lives</p>
